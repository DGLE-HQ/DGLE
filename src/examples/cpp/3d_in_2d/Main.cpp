...
void DGLE_API Init(void *pParameter)
{
	...
	p_res_man->Load(RESOURCE_PATH"meshes\\house\\tex_diffuse.jpg", (IEngineBaseObject *&)pTexHouse, TEXTURE_LOAD_DEFAULT_3D);
	p_res_man->Load(RESOURCE_PATH"meshes\\house\\house.dmd", (IEngineBaseObject *&)pMeshHouse, MMLF_FORCE_MODEL_TO_MESH);

	p_res_man->Load(RESOURCE_PATH"meshes\\trees\\tree_1.png", (IEngineBaseObject *&)pTexTree1, TEXTURE_LOAD_DEFAULT_3D);
	p_res_man->Load(RESOURCE_PATH"meshes\\trees\\tree_1.dmd", (IEngineBaseObject *&)pMeshTree1, MMLF_FORCE_MODEL_TO_MESH);

	p_res_man->Load(RESOURCE_PATH"meshes\\trees\\tree_2.png", (IEngineBaseObject *&)pTexTree2, TEXTURE_LOAD_DEFAULT_3D);
	p_res_man->Load(RESOURCE_PATH"meshes\\trees\\tree_2.dmd", (IEngineBaseObject *&)pMeshTree2, MMLF_FORCE_MODEL_TO_MESH);

	p_res_man->Load(RESOURCE_PATH"meshes\\trees\\tree_3.png", (IEngineBaseObject *&)pTexTree3, TEXTURE_LOAD_DEFAULT_3D);
	p_res_man->Load(RESOURCE_PATH"meshes\\trees\\tree_3.dmd", (IEngineBaseObject *&)pMeshTree3, MMLF_FORCE_MODEL_TO_MESH);

	p_res_man->Load(RESOURCE_PATH"meshes\\copter\\copter.png", (IEngineBaseObject *&)pTexCopter, TEXTURE_LOAD_DEFAULT_3D);
...
void DGLE_API Render(void *pParameter)
{
	...
	pRender2D->DrawTexture(pTexStone, TPoint2(0.f, 225.f), TPoint2(256.f, 256.f), 0.f, (E_EFFECT2D_FLAGS)(EF_VERTICES_COLORS | EF_BLEND));

	pRender2D->SetVerticesColors(ColorWhite(), TColor4(255, 255, 255, 0), TColor4(255, 255, 255, 0), ColorWhite());
	pRender2D->DrawTexture(pTexStone, TPoint2(0.f + 256.f, 225.f), TPoint2(256.f, 256.f), 0.f, (E_EFFECT2D_FLAGS)(EF_VERTICES_COLORS | EF_BLEND));
	
	pRender2D->SetVerticesColors(ColorWhite(), TColor4(255, 255, 255, 0), TColor4(255, 255, 255, 0), TColor4(255, 255, 255, 0));
	pRender2D->DrawTexture(pTexStone, TPoint2(0.f + 256.f, 225.f + 256.f), TPoint2(256.f, 256.f), 0.f, (E_EFFECT2D_FLAGS)(EF_VERTICES_COLORS | EF_BLEND));

	pRender2D->SetVerticesColors(TColor4(255, 255, 255, 0), ColorWhite(), TColor4(255, 255, 255, 0), TColor4(255, 255, 255, 0));
	pRender2D->DrawTexture(pTexStone, TPoint2(0.f, 225.f + 256.f), TPoint2(256.f, 256.f), 0.f, (E_EFFECT2D_FLAGS)(EF_VERTICES_COLORS | EF_BLEND));

	pRender2D->SetColorMix(ColorBlack(128)); // set color mix to semi-transparent black

	// Draw zombie. First draw shadow then zombie itself.
	pRender2D->DrawTextureSprite(pTexZombie, stZombiePos + TPoint2(10.f, 10.f), TPoint2(128, 128.f), (uint)fZombieAnimFrame, fZombieAngle + 90.f, (E_EFFECT2D_FLAGS)(EF_COLOR_MIX | EF_BLEND));
	pRender2D->DrawTextureSprite(pTexZombie, stZombiePos, TPoint2(128, 128.f), (uint)fZombieAnimFrame, fZombieAngle + 90.f);

	// Draw 3D models.
	
	// Before model itself we render its shadow. For houses we use simple rectangles, for copter - ellipse, for trees we use their 3D models but scale them to zero by Z axis.
	
	pRender2D->DrawRectangle(TRectF(-20, 75, 425, 275), ColorBlack(128), 0.f, PF_FILL);
	pRender2D->DrawMesh(pMeshHouse, pTexHouse, TPoint2(180.f, 150.f), TVector3(400.f, 400.f, 600.f));
	
	pRender2D->DrawRectangle(TRectF(510, 355, 275, 425), ColorBlack(128), 0.f, PF_FILL);
	pRender2D->DrawMesh(pMeshHouse, pTexHouse, TPoint2(600.f, 550.f), TVector3(400.f, 400.f, 600.f), TVector3(0.f, 0.f, 1.f), 90.f);

	pRender2D->DrawMesh(pMeshTree1, pTexTree1, TPoint2(900.f, 500.f), TVector3(400.f, 400.f, 0.f), TVector3(), 0.f, true, 90.f, (E_EFFECT2D_FLAGS)(EF_COLOR_MIX | EF_BLEND));
	pRender2D->DrawMesh(pMeshTree1, pTexTree1, TPoint2(900.f, 500.f), TVector3(400.f, 400.f, 500.f));

	pRender2D->DrawMesh(pMeshTree1, pTexTree1, TPoint2(-250.f, 300.f), TVector3(400.f, 400.f, 0.f), TVector3(), 0.f, true, 90.f, (E_EFFECT2D_FLAGS)(EF_COLOR_MIX | EF_BLEND));
	pRender2D->DrawMesh(pMeshTree1, pTexTree1, TPoint2(-250.f, 300.f), TVector3(400.f, 400.f, 500.f));

	pRender2D->DrawMesh(pMeshTree2, pTexTree2, TPoint2(0.f, 450.f), TVector3(300.f, 300.f, 0.f), TVector3(), 0.f, true, 90.f, (E_EFFECT2D_FLAGS)(EF_COLOR_MIX | EF_BLEND));
	pRender2D->DrawMesh(pMeshTree2, pTexTree2, TPoint2(0.f, 450.f), TVector3(300.f, 300.f, 400.f));

	pRender2D->DrawMesh(pMeshTree1, pTexTree2, TPoint2(500.f, 150.f), TVector3(400.f, 400.f, 0.f), TVector3(), 0.f, true, 90.f, (E_EFFECT2D_FLAGS)(EF_COLOR_MIX | EF_BLEND));
	pRender2D->DrawMesh(pMeshTree1, pTexTree2, TPoint2(500.f, 150.f), TVector3(400.f, 400.f, 500.f));

	pRender2D->DrawMesh(pMeshTree3, pTexTree3, TPoint2(50.f, 750.f), TVector3(300.f, 300.f, 0.f), TVector3(), 0.f, true, 90.f, (E_EFFECT2D_FLAGS)(EF_COLOR_MIX | EF_BLEND));
	pRender2D->DrawMesh(pMeshTree3, pTexTree3, TPoint2(50.f, 750.f), TVector3(300.f, 300.f, 300.f));

	pRender2D->DrawMesh(pMeshTree3, pTexTree3, TPoint2(800.f, 200.f), TVector3(400.f, 400.f, 0.f), TVector3(), 0.f, true, 90.f, (E_EFFECT2D_FLAGS)(EF_COLOR_MIX | EF_BLEND));
	...
	pRender2D->DrawEllipse(stCopterPos + TPoint2(50.f, 50.f), TPoint2(250.f, 35.f), 32, ColorBlack(128), fCopterAngle, PF_FILL);
	// Rotor shadow makes it all blinking so better not to draw it.
	//pRender2D->DrawTexture(pTexVint, vint_pos + TPoint2(50.f, 50.f), TPoint2(400.f, 400.f), uiCounter * 25.f, (E_EFFECT2D_FLAGS)(EF_COLOR_MIX | EF_BLEND));

	pRender2D->DrawMesh(pMeshCopter, pTexCopter, stCopterPos, TPoint3(600.f, 600.f, 600.f), TVector3(0.f, 0.f, 1.f), fCopterAngle, false);
	pRender2D->DrawTexture(pTexVint, vint_pos, TPoint2(400.f, 400.f), uiCounter * 25.f);
