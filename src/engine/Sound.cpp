...
DGLE_RESULT DGLE_API CSound::PauseAllChannels(bool bPaused)
{
	return E_NOTIMPL;
}
...
DGLE_RESULT DGLE_API CSound::SetMaxChannelsCount(uint uiCount)
{
	return E_NOTIMPL;
}

DGLE_RESULT DGLE_API CSound::SetListnerPosition(const TPoint3 &stCoords)
{
	return E_NOTIMPL;
}

DGLE_RESULT DGLE_API CSound::GetListnerPosition(TPoint3 &stCoords)
{
	return E_NOTIMPL;
}

DGLE_RESULT DGLE_API CSound::SetListnerOrientation(const TVector3 &stDir, const TVector3 &stUp)
{
	return E_NOTIMPL;
}

DGLE_RESULT DGLE_API CSound::GetListnerOrientation(TVector3 &stDir, TVector3 &stUp)
{
	return E_NOTIMPL;
}
