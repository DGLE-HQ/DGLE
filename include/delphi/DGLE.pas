...
//Render2D interface//
    ...
    //Advanced
		...
		function SetBlendMode(eMode :{E_EFFECT2D_BLENDING_FLAGS}Integer = EBF_NORMAL): DGLE_RESULT; stdcall;
    ...
    function GetRotationPoint(out stCoords: TPoint2): DGLE_RESULT; stdcall;
		...
		function GetBlendMode(out eMode {E_EFFECT2D_BLENDING_FLAGS}: Integer): DGLE_RESULT; stdcall;
...
//Render3D interface//
	...
	['{5275F43A-4FF9-48b2-B88E-B2F842461AB3}']
		...
		function SetBlendMode(eMode :{E_EFFECT2D_BLENDING_FLAGS}Integer = EBF_NORMAL): DGLE_RESULT; stdcall;
		function ToggleAlphaTest(bEnabled : Boolean; fAlphaMinTreshold : Single = 0.25): DGLE_RESULT; stdcall;
		...
		function EnableLighting(enable: Boolean): DGLE_RESULT; stdcall;
		function SetAmbient(const color: TColor4): DGLE_RESULT; stdcall;
		function GetAmbient(out color: TColor4): DGLE_RESULT; stdcall;
...
//Light interface//
	...
	['{EB73AC84-A465-4554-994D-8BED29744C9D}']
		...
		function SetPos(const stPos: TPoint3): DGLE_RESULT; stdcall;
		function SetDir(const stPos: TVector3): DGLE_RESULT; stdcall;
		function SetRange(range: Single): DGLE_RESULT; stdcall;
		function SetConstantAttenuation(attenuation: Single): DGLE_RESULT; stdcall;
		function SetLinearAttenuation(attenuation: Single): DGLE_RESULT; stdcall;
		function SetQuadraticAttenuation(attenuation: Single): DGLE_RESULT; stdcall;
		...
		function GetPos(out stPos: TPoint3): DGLE_RESULT; stdcall;
		function GetDir(out stDir: TVector3): DGLE_RESULT; stdcall;
		function GetRange(out range: Single): DGLE_RESULT; stdcall;
		function GetConstantAttenuation(out attenuation: Single): DGLE_RESULT; stdcall;
		function GetLinearAttenuation(out attenuation: Single): DGLE_RESULT; stdcall;
		function GetQuadraticAttenuation(out attenuation: Single): DGLE_RESULT; stdcall;
...
//Material interface//
	...
	['{B6506749-BB41-423d-B6C0-982081EF63F9}']
		...
		function SetAmbientColor(const stColor : TColor4): DGLE_RESULT; stdcall;
		function SetDiffuseColor(const stColor : TColor4): DGLE_RESULT; stdcall;
		function SetSpecularColor(const stColor : TColor4): DGLE_RESULT; stdcall;
		function SetHeightScale(scale : Single): DGLE_RESULT; stdcall;
		function SetEnvAmount(amount : Single): DGLE_RESULT; stdcall;
		function SetShininess(shininess : Single): DGLE_RESULT; stdcall;
		function SetTexMappingMode(eTexMapping :{E_TEX_MAPPING} Integer): DGLE_RESULT; stdcall;
		function SetDiffuseTexture(pTexture: ITexture): DGLE_RESULT; stdcall;
		function SetSpecularTexture(pTexture: ITexture): DGLE_RESULT; stdcall;
		function SetNormalTexture(pTexture: ITexture): DGLE_RESULT; stdcall;
		function SetHeightTexture(pTexture: ITexture): DGLE_RESULT; stdcall;
		function SetEnvTexture(pTexture: ITexture): DGLE_RESULT; stdcall;
		function SetEnvMask(pTexture : ITexture): DGLE_RESULT; stdcall;
		function SetNormalTechnique({E_NORMAL_TECHNIQUE} technique : Integer ): DGLE_RESULT; stdcall;
		function SetParallaxTechnique( {E_PARALLAX_TECHNIQUE} technique : Integer ): DGLE_RESULT; stdcall;
		function GetAmbientColor(out stColor: TColor4): DGLE_RESULT; stdcall;
		function GetDiffuseColor(out stColor: TColor4): DGLE_RESULT; stdcall;
		function GetSpecularColor(out stColor: TColor4): DGLE_RESULT; stdcall;
		function GetHeightScale(out scale : Single): DGLE_RESULT; stdcall;
		function GetEnvAmount(out amount : Single): DGLE_RESULT; stdcall;
		function GetShininess(out shininess : Single): DGLE_RESULT; stdcall;
		function GetTexMappingMode(out eTexMapping : {E_TEX_MAPPING}Integer): DGLE_RESULT; stdcall;
		function GetDiffuseTexture(out pTexture:ITexture): DGLE_RESULT; stdcall;
		function GetSpecularTexture(out pTexture:ITexture): DGLE_RESULT; stdcall;
		function GetNormalTexture(out pTexture:ITexture): DGLE_RESULT; stdcall;
		function GetHeightTexture(out pTexture:ITexture): DGLE_RESULT; stdcall;
		function GetEnvTexture(out pTexture:ITexture): DGLE_RESULT; stdcall;
		function GetEnvMask(out pTexture:ITexture): DGLE_RESULT; stdcall;
		function GetNormalTechnique({E_NORMAL_TECHNIQUE} out technique : Integer): DGLE_RESULT; stdcall;
		function GetParallaxTechnique({E_PARALLAX_TECHNIQUE} out technique : Integer): DGLE_RESULT; stdcall;
...
//Mesh interface//
	...
	['{85E360A8-07B3-4f22-AA29-07C7FC7C6893}']
		...
		function GetGeometryInfo(out uiDataSize : Cardinal; out eCreationFlags :{E_MESH_CREATION_FLAGS}Integer): DGLE_RESULT; stdcall;
		{Format x,y,z*vertex_count, nx,ny,nz*vertex_count s,q*vertex_count tx,ty,tz,bx,by,bz*vertex_count int16*uiFacesCount}
		function GetGeometry(out pubtData : PByte): DGLE_RESULT; stdcall;
		function SetGeometry(const pubtData : PByte): DGLE_RESULT; stdcall;

	end;

//Skeleton xform interface//

	ISkeletonXform = interface(IEngBaseObj)
...
//Model interface//
	...
	['{6107C296-FC07-48d1-B6A7-F88CC2DAE897}']
		...
		function Draw(fFrameIdx : Single): DGLE_RESULT; stdcall;
	...
	['{DC6E4812-6B06-4de8-9DEF-2A13740BC45E}']
		...
		function SetTargets(pSrc : ITexture; pDst : ITexture ): DGLE_RESULT; stdcall;
		function SetBlurAmount(fBlur : Single ): DGLE_RESULT; stdcall;
		function SetBloomAmount(fBloom : Single): DGLE_RESULT; stdcall;
		function SetBloomThreshold(fThreshold : Single): DGLE_RESULT; stdcall;
		function ToggleMonochrome(bEnable : boolean): DGLE_RESULT; stdcall;
		function Perform(): DGLE_RESULT; stdcall;
